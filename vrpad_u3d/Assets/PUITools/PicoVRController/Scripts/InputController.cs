...
public class InputController : MonoBehaviour {
    ...
    public static InputController GetInstance()
    {
        if(m_Instance == null)
        {
            ...
            try
            {
                if (m_Instance.currentDevice == DeviceMode.FalconCV)
...
//            Debug.Log("头盔上的返回键");
    ...
    public void InputListenerController()
    {
        if (Pvr_UnitySDKAPI.Controller.UPvr_GetKeyUp(m_Hand, Pvr_UnitySDKAPI.Pvr_KeyCode.APP) ||
            Pvr_UnitySDKAPI.Controller.UPvr_GetKeyUp(m_Hand, Pvr_UnitySDKAPI.Pvr_KeyCode.B )||
            Pvr_UnitySDKAPI.Controller.UPvr_GetKeyUp(m_Hand, Pvr_UnitySDKAPI.Pvr_KeyCode.Y))  /**App/B/y键  暂定为返回、退出 **/
        {
        ...
        if (Pvr_UnitySDKAPI.Controller.UPvr_GetKeyUp(m_Hand, Pvr_UnitySDKAPI.Pvr_KeyCode.TOUCHPAD) ||
            Pvr_UnitySDKAPI.Controller.UPvr_GetKeyUp(m_Hand, Pvr_UnitySDKAPI.Pvr_KeyCode.A) ||
            Pvr_UnitySDKAPI.Controller.UPvr_GetKeyUp(m_Hand, Pvr_UnitySDKAPI.Pvr_KeyCode.X)) /**TouchPad/A/X键监听**/
        {
    ...
    public bool TriggerDown
    {
        get
        {
            ...
            return Input.GetKeyDown(KeyCode.JoystickButton0) ||
                ...
                Pvr_UnitySDKAPI.Controller.UPvr_GetKeyDown(m_Hand, Pvr_UnitySDKAPI.Pvr_KeyCode.A) ||
                Pvr_UnitySDKAPI.Controller.UPvr_GetKeyDown(m_Hand, Pvr_UnitySDKAPI.Pvr_KeyCode.X) ||
    ...
    public bool Triggering
    {
        get
        {
            ...
            return Input.GetKey(KeyCode.Joystick1Button0) ||
                ...
                Pvr_UnitySDKAPI.Controller.UPvr_GetKey(m_Hand, Pvr_UnitySDKAPI.Pvr_KeyCode.A) ||
                Pvr_UnitySDKAPI.Controller.UPvr_GetKey(m_Hand, Pvr_UnitySDKAPI.Pvr_KeyCode.X) ||
